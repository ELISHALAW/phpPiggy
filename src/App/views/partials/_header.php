...
<head>
  ...
  <title><?= e($title) ?? "Php piggy" ?> - PhpPiggy </title>
...
<body class="bg-indigo-50 font-['Outfit']">
  ...
  <header class="bg-indigo-900">
    <nav class="mx-auto flex container items-center justify-between py-4 px-6" aria-label="Global">
      <a href="/" class="p-1.5 text-white text-2xl font-bold">PHPiggy</a>
      <!-- Navigation Links -->
